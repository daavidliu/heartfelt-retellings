...
def narrative_QA_prompt(question, predicates):
    ...
    return f"""
        ...
        AW(see(James, sigh(Emma)))  
        AW(see(James, checkPhone(Emma)))  
        BW_James(bored(Emma))
        WW_James(WW_Emma(leave(Emma, party)))
        BW_James(OW_Emma(stay(Emma, party)))

        Story: "James watched Emma across the room. She sighed and checked her phone. He was convinced she was bored. He hoped she wanted to leave the party. James assumed she felt obligated to remain."
